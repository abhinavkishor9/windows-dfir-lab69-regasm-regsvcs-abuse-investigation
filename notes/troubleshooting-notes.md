...
## 11. General Investigative Lesson

Several negative searches occurred during this lab.

The important troubleshooting principle is:

`No matching event found != activity disproved`

The final report therefore preserves telemetry limitations instead of turning missing evidence into unsupported conclusions.

This approach is important in SOC and DFIR investigations because conclusions must remain tied to the available evidence.
